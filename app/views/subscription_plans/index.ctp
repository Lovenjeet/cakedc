<div class="subscriptionPlans index">
	<h2><?php __('Subscription Plans');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $subscriptionPlan['SubscriptionPlan']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $subscriptionPlan['SubscriptionPlan']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $subscriptionPlan['SubscriptionPlan']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $subscriptionPlan['SubscriptionPlan']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
